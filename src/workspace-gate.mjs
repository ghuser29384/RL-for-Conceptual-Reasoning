...
root.innerHTML = `
  ...
  <main class="mpWorkspaceGate" id="workspace-gate">
    <article aria-labelledby="workspace-gate-title">
      ...
      <p>
        This workspace is not publicly open. Metaphilosophy has not started production expert ratings. The route will remain closed until methodology, protected items, the qualified panel, calibration, privacy and payment procedures, controlled assignments, and final readiness have passed their separate gates.
      </p>
      <p>
        No application, assignment, rating task, deadline, payment commitment, or expert-result claim is available here. Public research materials remain available for inspection.
      </p>
