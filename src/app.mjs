...
const state = {
  ...
  workflowPublicDatasetDocumentKindFilter: "",
  workflowPublicDatasetDocumentStatusFilter: "",
...
const workflowEvidenceCollections = [
  ...
  },
  {
    ...
    label: "Release artifact templates",
    endpoint: "/api/v1/release-artifacts/template",
    resourceKey: "releaseArtifactPackageTemplate",
    group: "Release",
    summary: "Read-only package templates for the six submitted release artifacts that gate release verification.",
  },
  {
  ...
  {
    id: "release-version-manifest-template",
    label: "Release version templates",
    endpoint: "/api/v1/release-version-manifest/template",
    resourceKey: "releaseVersionManifestTemplate",
    group: "Release",
    summary: "Read-only ReleaseVersion and ReleaseFreeze request templates bound to the current release manifest.",
  },
  {
    id: "public-dataset-package-manifest",
    label: "Dataset v0.1 package manifest",
    endpoint: "/api/v1/public-dataset-package-manifest",
  ...
  {
    id: "public-dataset-package-validation-template",
    label: "Dataset v0.1 package validation template",
    endpoint: "/api/v1/public-dataset-package-files/validate/template",
  ...
  },
  {
    ...
    group: "Release",
    summary:
      "Read-only per-surface public-first guard for leaderboard, API evaluator, public training export, and judge-model launch after Dataset v0.1.",
  },
  {
  ...
  },
  {
    ...
    label: "Dataset v0.1 document templates",
    endpoint: "/api/v1/public-dataset-documents/template",
    resourceKey: "publicDatasetDocumentTemplate",
    group: "Release",
    summary: "Read-only dataset-card and methodology-report request templates with current linked release-object ids.",
  },
  {
...
function workflowReadbackPanel(collection) {
  ...
  const releaseReportSectionFilters =
    collection.id === "release-report-sections"
      ...
      : "";
  const releaseArtifactPackageTemplateFilters =
    collection.id === "release-artifact-package-template"
      ? `<div class="workflowReadbackControls">
          <label>
            <span>Artifact kind</span>
            <input id="workflowArtifactKindFilter" type="text" value="${escapeHtml(state.workflowArtifactKindFilter)}" placeholder="label_snapshot" />
          </label>
          <label>
            <span>Evidence status</span>
            <input id="workflowReleaseArtifactEvidenceStatusFilter" type="text" value="${escapeHtml(state.workflowReleaseArtifactEvidenceStatusFilter)}" placeholder="no_submitted_artifact" />
          </label>
          <label>
            <span>Status</span>
          ...
          <label>
            <span>Route</span>
            <input id="workflowRouteFilter" type="text" value="${escapeHtml(state.workflowRouteFilter)}" placeholder="/api/v1/release-artifacts/template/label_snapshot" />
          </label>
        </div>`
      : "";
  const releaseVersionManifestFilters =
    collection.id === "release-version-manifest"
      ...
      : "";
  const releaseVersionManifestTemplateFilters =
    collection.id === "release-version-manifest-template"
      ? `<div class="workflowReadbackControls">
          <label>
            <span>Template kind</span>
            <input id="workflowTemplateKindFilter" type="text" value="${escapeHtml(state.workflowTemplateKindFilter)}" placeholder="release_version" />
          </label>
          <label>
            <span>Status</span>
            <input id="workflowActionStatusFilter" type="text" value="${escapeHtml(state.workflowActionStatusFilter)}" placeholder="open" />
          ...
          <label>
            <span>Route</span>
            <input id="workflowRouteFilter" type="text" value="${escapeHtml(state.workflowRouteFilter)}" placeholder="/api/v1/release-version-manifest/template/release-version" />
          </label>
        </div>`
      : "";
  const publicDatasetPackageManifestFilters =
    collection.id === "public-dataset-package-manifest"
      ? `<div class="workflowReadbackControls">
          <label>
            <span>Step kind</span>
            <input id="workflowTemplateKindFilter" type="text" value="${escapeHtml(state.workflowTemplateKindFilter)}" placeholder="public_documentation" />
          </label>
          <label>
            <span>Status</span>
            <input id="workflowActionStatusFilter" type="text" value="${escapeHtml(state.workflowActionStatusFilter)}" placeholder="open" />
          ...
          <label>
            <span>Route</span>
            <input id="workflowRouteFilter" type="text" value="${escapeHtml(state.workflowRouteFilter)}" placeholder="/api/v1/public-dataset-package-manifest/public-documentation" />
          </label>
        </div>`
      : "";
  ...
  const publicDatasetPackageFileTemplateFilters =
    collection.id === "public-dataset-package-file-template"
      ...
      : "";
  const publicDatasetPackageValidationTemplateFilters =
    collection.id === "public-dataset-package-validation-template"
      ? `<div class="workflowReadbackControls">
          ...
          <label>
            <span>Route</span>
            <input id="workflowRouteFilter" type="text" value="${escapeHtml(state.workflowRouteFilter)}" placeholder="/api/v1/public-dataset-package-files/validate/template/dataset-card" />
          </label>
        </div>`
      : "";
    ...
    collection.id === "public-dataset-downstream-launches"
      ? `<div class="workflowReadbackControls">
          <label>
            ...
            <input id="workflowTemplateKindFilter" type="text" value="${escapeHtml(state.workflowTemplateKindFilter)}" placeholder="leaderboard" />
          </label>
          <label>
            <span>Status</span>
            <input id="workflowActionStatusFilter" type="text" value="${escapeHtml(state.workflowActionStatusFilter)}" placeholder="open" />
          ...
          <label>
            <span>Route</span>
            <input id="workflowRouteFilter" type="text" value="${escapeHtml(state.workflowRouteFilter)}" placeholder="/api/v1/public-dataset-downstream-launches/public-leaderboard" />
          </label>
        </div>`
      : "";
  ...
  const derivedChecklistFilters =
    isDerivedChecklistCollection(collection) || isModelRunProvenanceCollection(collection)
      ...
      : "";
  const publicDatasetDocumentTemplateFilters =
    collection.id === "public-dataset-document-template"
      ? `<div class="workflowReadbackControls">
          <label>
            <span>Document kind</span>
            <select id="workflowPublicDatasetDocumentKindFilter">
              ${["", "dataset_card", "methodology_report"]
                .map(
                  (item) =>
                    `<option ${item === state.workflowPublicDatasetDocumentKindFilter ? "selected" : ""} value="${escapeHtml(item)}">${escapeHtml(item ? humanize(item) : "All document kinds")}</option>`,
                )
                .join("")}
            </select>
          </label>
          <label>
            <span>Readiness</span>
            <input id="workflowPublicDatasetDocumentStatusFilter" type="text" value="${escapeHtml(state.workflowPublicDatasetDocumentStatusFilter)}" placeholder="open" />
          </label>
          <label>
            <span>Route</span>
            <input id="workflowRouteFilter" type="text" value="${escapeHtml(state.workflowRouteFilter)}" placeholder="/api/v1/public-dataset-documents/template" />
          </label>
        </div>`
      : "";
  ...
  return `
    <div class="workflowReadback">
      ...
      ${releaseArtifactPackageTemplateFilters}
      ...
      ${publicDatasetPackageValidationTemplateFilters}
...
function workflowCollectionResultSummaryMetrics(collection, result) {
  ...
  if (collection.id === "public-dataset-document-template") {
    ...
    return [
      ...
      ["Open readiness rows", counts.openReadinessRows ?? "not reported"],
      ["Document kinds", workflowCountMapSummary(counts.byDocumentKind)],
      ["Readiness states", workflowCountMapSummary(counts.byReadinessStatus)],
      ["Write route", result.writeRoute ?? "not available"],
      ["Validate route", result.singleRecordValidateOnlyRoute ?? "not available"],
    ];
  }
  if (collection.id === "release-version-manifest-template") {
    const counts = result.filteredCounts ?? result.counts ?? {};
    return [
      ["Template rows", counts.templateRows ?? result.count ?? "not reported"],
      ["Open templates", counts.openRows ?? "not reported"],
      ["Release status", humanize(result.releaseUseStatus ?? "not reported")],
      ["Target scale", humanize(result.targetScaleStatus ?? "not reported")],
      ["Template kinds", workflowCountMapSummary(counts.byTemplateKind)],
      ["ReleaseVersion route", result.writeRoutes?.releaseVersion ?? "not available"],
      ["ReleaseFreeze route", result.writeRoutes?.releaseFreeze ?? "not available"],
    ];
  }
  if (collection.id === "public-dataset-package-manifest") {
    const counts = result.filteredCounts ?? result.counts ?? {};
    return [
      ["Package status", humanize(result.packageStatus ?? "not reported")],
  ...
  if (collection.id === "public-dataset-package-validation-template") {
    const counts = result.filteredCounts ?? result.counts ?? {};
    return [
      ["Validation template", humanize(result.validationTemplateStatus ?? "not reported")],
      ["Current blocker", result.currentBlockingTemplate ? humanize(result.currentBlockingTemplate.label ?? result.currentBlockingTemplate.id) : "none"],
      ["Request files", counts.requestTemplateRows ?? result.requestBodyTemplate?.files?.length ?? result.count ?? "not reported"],
      ["Open rows", counts.openRows ?? "not reported"],
      ["File formats", workflowCountMapSummary(counts.byFileFormat)],
  ...
  if (collection.id === "public-dataset-downstream-launches") {
    const counts = result.filteredCounts ?? result.counts ?? {};
    return [
      ["Launch guard", humanize(result.launchGuardStatus ?? "not reported")],
      ["Current blocker", result.currentBlockingLaunch ? humanize(result.currentBlockingLaunch.label ?? result.currentBlockingLaunch.id) : "none"],
      ["Blocked surfaces", counts.blockedRows ?? "not reported"],
      ["Launch kinds", workflowCountMapSummary(counts.byLaunchKind)],
      ["Dataset readiness", result.sourceRoutes?.publicDatasetReadiness ?? "not available"],
      ["Package manifest", result.sourceRoutes?.publicDatasetPackageManifest ?? "not available"],
    ];
  }
  if (collection.id === "release-artifact-package-template") {
    ...
    return [
      ["Template rows", counts.templateRows ?? result.count ?? "not reported"],
      ["Open artifacts", counts.openRows ?? "not reported"],
      ["Package JSONL rows", counts.packageJsonlRows ?? "not reported"],
      ["Single-record rows", counts.singleRecordRows ?? "not reported"],
      ["Evidence states", workflowCountMapSummary(counts.byEvidenceStatus)],
...
function workflowCollectionPreview(collection, previewItems) {
  ...
  if (collection.id === "release-version-manifest-template") {
    return `<div class="operatorActionPreview">${previewItems.map(releaseVersionManifestTemplatePreviewRow).join("")}</div>`;
  }
  ...
  if (collection.id === "public-dataset-document-template") {
    return `<div class="operatorActionPreview">${previewItems.map(publicDatasetDocumentTemplatePreviewRow).join("")}</div>`;
  }
  if (collection.id === "release-artifact-package-template") {
    return `<div class="operatorActionPreview">${previewItems.map(releaseArtifactPackageTemplatePreviewRow).join("")}</div>`;
  }
...
function releaseVersionManifestTemplatePreviewRow(item) {
  const routeSummary =
    [item.templateReadbackRoute, item.writeRoute, item.singleRecordValidateOnlyRoute, item.manifestCheckRoute].filter(Boolean).join(", ") ||
    "not available";
  const linkedIds = item.linkedReleaseObjectIds ?? {};
  const outputArtifacts = Array.isArray(linkedIds.immutableOutputArtifactIds) ? linkedIds.immutableOutputArtifactIds.join(", ") : "not reported";
  return `
    <article class="operatorActionCard">
      <div class="operatorActionCardHeader">
        <div>
          <strong>${escapeHtml(item.label ?? humanize(item.templateKind ?? "Release template"))}</strong>
          <span>${escapeHtml(humanize(item.templateKind ?? "release template"))}</span>
        </div>
        <span>${escapeHtml(humanize(item.templateStatus ?? "template ready"))}</span>
      </div>
      ${metricList([
        ["Template only", item.templateOnly ? "yes" : "no"],
        ["Current release", humanize(item.releaseUseStatus ?? "not reported")],
        ["Target scale", item.targetScaleStatus ? humanize(item.targetScaleStatus) : "not reported"],
        ...
        ["Required fields", Array.isArray(item.requiredFields) ? item.requiredFields.length : "not reported"],
        ["Routes", routeSummary],
      ])}
    </article>
  `;
...
function publicDatasetPackageManifestPreviewRow(item) {
  const readinessRows =
  ...
  const templateRoutes =
    Array.isArray(item.templateRoutes) && item.templateRoutes.length ? item.templateRoutes.slice(0, 4).join(", ") : "not template-backed";
  ...
  return `
    <article class="operatorActionCard">
      <div class="operatorActionCardHeader">
        <div>
          <strong>${escapeHtml(item.label ?? item.id ?? "Dataset package step")}</strong>
          <span>${escapeHtml(humanize(item.stepKind ?? "public dataset package"))}</span>
        </div>
        <span>${escapeHtml(humanize(item.status ?? "not reported"))}</span>
      </div>
      ${metricList([
...
function publicDatasetPackageValidationTemplatePreviewRow(item) {
  const requiredFields =
    Array.isArray(item.requiredFields) && item.requiredFields.length ? item.requiredFields.slice(0, 6).map(humanize).join(", ") : "not reported";
  const routes =
    Array.isArray(item.verificationRoutes) && item.verificationRoutes.length ? item.verificationRoutes.slice(0, 5).join(", ") : "not available";
  ...
  return `
    <article class="operatorActionCard">
      <div class="operatorActionCardHeader">
        <div>
          <strong>${escapeHtml(item.label ?? item.id ?? "Package validation template")}</strong>
          <span>${escapeHtml(item.expectedFilename ?? "expected package file")}</span>
        </div>
        <span>${escapeHtml(humanize(item.status ?? "not reported"))}</span>
      </div>
      ${metricList([
        ["Validation route", item.validationRoute ?? "not available"],
        ["Validation only", item.validationOnly ? "yes" : "no"],
        ["Replacement required", item.replacementRequired ? "yes" : "no"],
        ["Format", item.fileFormat ? humanize(item.fileFormat) : "not reported"],
        ["Template hash", item.templateContentHash ?? "not reported"],
...
function publicDatasetDownstreamLaunchGuardPreviewRow(item) {
  const readinessRows =
    Array.isArray(item.blockingReadinessRowIds) && item.blockingReadinessRowIds.length
      ? item.blockingReadinessRowIds.map(humanize).join(", ")
      : "no readiness blockers";
  const packageSteps =
    Array.isArray(item.blockingPackageStepIds) && item.blockingPackageStepIds.length
      ? item.blockingPackageStepIds.map(humanize).join(", ")
  ...
  const reasons =
    Array.isArray(item.publicFirstReviewReasons) && item.publicFirstReviewReasons.length
      ...
      : "no public-first review reasons";
  return `
    <article class="operatorActionCard">
      <div class="operatorActionCardHeader">
        <div>
          <strong>${escapeHtml(item.label ?? item.id ?? "Downstream launch guard")}</strong>
          <span>${escapeHtml(humanize(item.launchKind ?? "downstream launch"))}</span>
        </div>
        <span>${escapeHtml(humanize(item.status ?? "not reported"))}</span>
      </div>
      ${metricList([
        ["Downstream artifact", item.downstreamArtifact ? humanize(item.downstreamArtifact) : "not reported"],
        ["Launch action", item.launchActionAvailable ? "available" : "not exposed by this guard"],
        ["Dataset package", item.datasetPackageStatus ? humanize(item.datasetPackageStatus) : "not reported"],
...
function publicDatasetDocumentTemplatePreviewRow(item) {
  const reviewReasons =
    Array.isArray(item.readinessReviewReasons) && item.readinessReviewReasons.length
      ? item.readinessReviewReasons.slice(0, 4).join(", ")
      : "no readiness review reasons";
  const linkedIds = item.linkedReleaseObjectIds ?? {};
  const linkedSummary = Object.entries(linkedIds)
  ...
  return `
    <article class="operatorActionCard">
      <div class="operatorActionCardHeader">
        <div>
          <strong>${escapeHtml(item.label ?? humanize(item.documentKind ?? "dataset document"))}</strong>
          <span>${escapeHtml(humanize(item.documentKind ?? "public dataset document"))}</span>
        </div>
        <span>${escapeHtml(item.templateOnly ? "template only" : "review")}</span>
      </div>
      ${metricList([
        ["Readiness", item.readinessStatus ? humanize(item.readinessStatus) : "not reported"],
        ["Review reasons", reviewReasons],
...
function releaseArtifactPackageTemplatePreviewRow(item) {
  const blockingFields =
    Array.isArray(item.blockingFields) && item.blockingFields.length
      ? item.blockingFields.slice(0, 6).join(", ")
      : "no blocking fields";
  const requiredFields =
    Array.isArray(item.requiredFields) && item.requiredFields.length
      ? item.requiredFields.slice(0, 7).join(", ")
      : "not reported";
  const routes =
    [
      item.payloadTemplateReadbackRoute,
      item.jsonlTemplateReadbackRoute,
  ...
  return `
    <article class="operatorActionCard">
      <div class="operatorActionCardHeader">
        <div>
          <strong>${escapeHtml(humanize(item.artifactKind ?? item.id ?? "release artifact"))}</strong>
          <span>${escapeHtml(item.submissionMode ? humanize(item.submissionMode) : "submission mode not reported")}</span>
        </div>
        <span>${escapeHtml(humanize(item.evidenceStatus ?? item.actionStatus ?? "not reported"))}</span>
      </div>
      ${metricList([
        ["Action", item.actionId ?? "not reported"],
...
function bindEvents({ selectedAssignment, labelSnapshot, manifests, releaseReport }) {
  ...
  document.getElementById("workflowCollection")?.addEventListener("change", (event) => {
    ...
    if (collection.id !== "release-artifact-package-template") {
      state.workflowReleaseArtifactEvidenceStatusFilter = "";
    }
    if (collection.id !== "release-version-manifest") {
    ...
    if (collection.id !== "public-dataset-document-template") {
      state.workflowPublicDatasetDocumentKindFilter = "";
      state.workflowPublicDatasetDocumentStatusFilter = "";
    }
    if (collection.id !== "rater-profile-evidence") {
...
function workflowCollectionEndpoint(collection) {
  ...
  if (collection.id === "release-artifact-package-template") {
    if (state.workflowArtifactKindFilter) url.searchParams.set("artifactKind", state.workflowArtifactKindFilter);
    if (state.workflowReleaseArtifactEvidenceStatusFilter) {
  ...
  if (collection.id === "public-dataset-downstream-launches") {
    if (state.workflowTemplateKindFilter) url.searchParams.set("launchKind", state.workflowTemplateKindFilter);
    if (state.workflowActionStatusFilter) url.searchParams.set("status", state.workflowActionStatusFilter);
    if (state.workflowPublicDatasetDownstreamFilter) url.searchParams.set("downstreamArtifact", state.workflowPublicDatasetDownstreamFilter);
    if (state.workflowRouteFilter) url.searchParams.set("route", state.workflowRouteFilter);
  }
  ...
  if (collection.id === "public-dataset-document-template" && state.workflowRouteFilter) {
    url.searchParams.set("route", state.workflowRouteFilter);
  }
  if (collection.id === "public-dataset-document-template") {
    if (state.workflowPublicDatasetDocumentKindFilter) {
      url.searchParams.set("documentKind", state.workflowPublicDatasetDocumentKindFilter);
    }
    if (state.workflowPublicDatasetDocumentStatusFilter) {
      url.searchParams.set("status", state.workflowPublicDatasetDocumentStatusFilter);
    }
  }
  if (collection.id === "rater-profile-evidence") {
