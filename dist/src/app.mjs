...
const workflowTemplates = [
  ...
  },
  {
    ...
    endpoint: () => "/api/v1/extraction-batches/import-jsonl",
    resourceKey: "extractionBatch",
    requiredRole: "admin",
    summary: "Import externally prepared JSONL argument extractions while preserving Phase 1 no-AI/no-promotion boundaries.",
    payload: () => {
      ...
      return {
        ...
        jsonl:
          `${JSON.stringify({
            ...
            extractedPositionText: "A good philosophical argument should make the inferential burden it carries explicit.",
  ...
  },
  {
    ...
    endpoint: () => "/api/v1/argument-extractions/argument-extraction-demo/review",
  ...
  return `
    <section class="panel">
      ...
      <div class="metricCards benchmarkMetricCards">
        ...
        ${metricCard("Accepted", String(counts.acceptedForPositionIntakeExtractions ?? 0), "future position intake only")}
