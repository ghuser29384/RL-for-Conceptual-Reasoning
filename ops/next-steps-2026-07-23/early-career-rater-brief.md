# Internal draft — early-career expert rater brief

**Not published or sent. Recruitment remains closed until Q-006, payment/legal readiness, and the exact pilot protocol are approved.**

## Role

Metaphilosophy is preparing a 48-critique pilot to test a blind, auditable workflow for expert evaluation of philosophical arguments. The pilot's bulk rating work is intended for six early-career experts. Two separate adjudicators handle triggered disagreement and final label-snapshot review.

This is a bounded volunteer research contribution with limited honoraria. It is not represented as employment, a per-rating wage, or full compensation for professional time.

## Recommended eligibility standard
...
Each critique is scored from 0 to 1 on:
...
The current ceiling reserves:

- **USD 400** for accepted core-rater units; and
- **USD 100** for accepted adjudicator units.
