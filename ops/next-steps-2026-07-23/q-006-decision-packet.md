...
4. conflict, prior-exposure, consent, and calibration status;
5. recipient jurisdictions and feasible payment methods;
6. the private process for identity, tax, payment, and sanctions-screening data;
7. the external-funding application owner;
8. the exact senior-adviser roster and outreach order;
9. the authorized sender and reply-handling owner; and
10. the readiness-signoff timestamp, from which the first-Monday start and 28-day end are derived.
